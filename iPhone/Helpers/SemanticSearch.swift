...
// (Al-Islam ships bundled vector packs for its Quran and hadith corpora and exports them from the
// app with "-exportSemanticPacks"; this app ships neither corpus, so its vectors are always built
// on device and there is nothing to export or audit.)
