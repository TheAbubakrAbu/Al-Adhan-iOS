...
enum AskAIRetriever {
    ...
    /// the reward of prayer" and "how do I pray" are answered by the articles, not by a timetable.
    /// It fetches only alongside a clock word.
    ...
    /// Words that make a question one about the clock. Useless alone ("time", "today" and "next"
    /// turn up in half the questions asked of the app), which is exactly why they used to drag the
    /// whole timetable into answers about charity: the gate below pairs them with
    /// `prayerGeneralWords` instead of firing on them (Abu, 2026-09-07).
        ...
        VStack(alignment: .leading, spacing: 18) {
            HStack(alignment: .top, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    Text("Ask anything about Islam")
                        .font(.headline)
                    Text("A question, a follow-up, a \u{201C}what does this mean\u{201D}: answered on your device by Apple Intelligence, with your prayer times and the app's own articles cited beneath each reply, ready to open. Nothing leaves your phone.")
                        .font(.footnote)
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    howItWorksRow(icon: "magnifyingglass", text: "Your question first searches this app's own prayer times and its Islam articles.")
