...
final class HisnDuaPlayer: ObservableObject {
    ...
    func toggle(_ url: URL) {
        ...
        stop()
        // Al-Islam routes this through `AuxiliaryAudio`, which pauses the Quran player and the
        // qiraat clip first; the only other audio here is the in-app adhan, which a short dua
        // clip must not talk over.
