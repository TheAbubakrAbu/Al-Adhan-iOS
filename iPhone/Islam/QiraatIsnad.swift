...
// (Al-Adhan's copy of Al-Islam's `iPhone/Quran/QiraatIsnad.swift`, which needs nothing from the
// Quran reader: it lives under Islam/ here because this app has no Quran module. Keep the two in
// lockstep by hand, like the other shims.)
//
